...
* Running the examples provided during the classes
    ** For each one of the following repositories
        *** link:https://github.com/isel-leic-pc/s2526v-li41d-li41n[https://github.com/isel-leic-pc/s2425v-li41d-li41n].
...
* In the `code/jvm` project present in link:https://github.com/pmhsfelix/course-jvm-concurrency[https://github.com/pmhsfelix/course-concurrency]:
